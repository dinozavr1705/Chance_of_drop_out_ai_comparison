...
4)Не смотря на то,что маленький batch увеличивает производительность и ускоряет адаптацию модели,он создает шум ,из-за чего градиент может выйти из локальных минимумов,высокий же batch делает обучение более стабильным
